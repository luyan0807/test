...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
   ...
   <script src="js/updateB.js"></script>
...
<div class="container">
	...
	<div class="row clearfix">
		<div class="col-md-4 column">
			<img alt="140x140" src="upload/${book.image }" class="img-thumbnail" />
		</div>
		<div class="col-md-4 column">
			<form action="bookinfo" class="form-inline" method="post" enctype="multipart/form-data">
				<div class="form-group">
					 ...
					 <div >
					 <input id="name" class="form-control" name="name" type="text" value="${book.name}" onblur="nameblur()"/>
					 </div>
				</div>
				...
				<div class="form-group">
					 ...
					 <div >
					 <input class="form-control" name="isbn" type="text" value="${book.isbn}" id="isbn" onblur="isbnblur()"/>
					 </div>
				</div>
					<div class="form-group">
					 ...
					 <div >
					 <input id="anthor" class="form-control" name="anthor" type="text" value="${book.anthor}" onblur="anthorblur()" />
					 </div>
				</div>
					<div class="form-group">
					 ...
					 <div >
					 <input class="form-control" id="price" onblur="priceblur()" name="price" type="text" value="${book.price}" />
					 </div>
				</div>
					<div class="form-group">
					 <label for="exampleInputPassword1">分类</label>
					 <div >
					 <select id="sel" onkeydown="showOptions2(this)" onfocus="inp='';" name="kindof" class="form-control" style="width:170px">
					 <option  value="${book.kindOf}"selected="selected">${book.kindOf}</option >
					...
					<div class="form-group">
					 ...
					 <div >
					 <input id="callnumber" class="form-control" name="callnumber" type="text" value="${book.callNumber}" onblur="callnumberblur()"/>
					 </div>
				</div>
					<div class="form-group">
				...
				<div class="form-group">
					...
					<select name="collection" class="form-control" style="width:170px">
					 <option  value="${book.collection}"selected="selected">${book.collection}</option >
				...
				<div class="form-group">
					 ...
					 <div >
					<textarea id="plots" class="form-control" rows="6" cols="50" name="plotSummary" onblur="plotSummaryblur()">${book.plotSummary }</textarea>
					 </div>
				</div>
				<div class="form-group">
        ...
        <div class="form-group">
					 ...
					 <input  id="publishname "class="form-control" name="publishname" type="text" value="${book.publishName}" onblur="publishnameblur()" />
		...
		<div class="form-group">
					 ...
					 <div >
					 <input id="publishdate" class="form-control" name="publishdate" type="text" value="${book.publishDate}" onblur="publishdateblur()" onkeyup="publishdateup()"/>
					 </div>
				</div>
		<div class="form-group">
					 ...
					 <div >
					 <input id="pageNo" class="form-control" name="pageNo" type="text" value="${book.pageNo}" onblur="numblur('pageNo')" />
					 </div>
				</div>
       <div class="form-group">
					 ...
					 <div >
					 <input id="edition" class="form-control" name="edition" type="text" value="${book.edition}" onblur="numblur('edition')" />
					 </div>
				</div>
			<div class="form-group">
					 ...
					 <div >
					 <input id="Num" class="form-control" name="num" type="text"  value="${book.num}" onblur="Numblur()"/>
					 </div>
				</div>
		<div class="form-group">
					 ...
					 <div >
					 <textarea id="abstracts" class="form-control" rows="3" cols="50" name="abstracts" onblur="abstractsblur()">${book.abstracts} </textarea>
					 </div>
				</div>
